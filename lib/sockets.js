	...
	var client = socket.of('/chausauge').on('connection', function (socket) {
		...
		*/
		...
		socket.on('track:vote', function(data) {
			...
			var Queue = mongoose.model('Queue');
			var queue = new Queue();
			var doc   = queue.vote(data, client);
		});
		...
		//var data = {'key': 't35041553', 'user_id': '571656f8-d440-447f-684d-f346b49a682e'};
		var data = {
			'key': 't35041587abc',
			'user_id': '571656f8-d440-447f-684d-f346b49a682e',
			'name': 'Track Name',
			'art': 'http://www.someart.com',
			'album': 'Some Album',
			'artist': 'Some Artist',
			'duration': 240,
			'explicit': false
